...
class DownScale(nn.Module):
    ...
    def forward(
        ...
        if input.shape[1] == 1:
        # If we have 1 channel (raw audio), project it to 1024
...
class FocalDownScale(nn.Module):
    ...
    def __init__(
        ...
        print(
            f"Initializing FocalDownScale with input_dim={input_dim}, output_dim={output_dim}, downscale_factor={downscale_factor}, focal_window={focal_window}, "
            f"focal_level={focal_level}, focal_factor={focal_factor}, dropout={dropout}, use_post_norm={use_post_norm}, use_layerscale={use_layerscale}, layerscale_init={layerscale_init}, tanhscale_init={tanhscale_init}, normalize_modulator={normalize_modulator}, causal={causal}, window_size={window_size}"
        )
...
class FocalEncoder(nn.Module):
    ...
    def __init__(
        ...
        print(
            ...
            f"hidden_dims={hidden_dims}, downscale_factors={downscale_factors}, "
            f"focal_window={focal_window}, focal_level={focal_level}, focal_factor={focal_factor}, "
            f"dropout={dropout}, use_post_norm={use_post_norm}, "
            f"use_layerscale={use_layerscale}, layerscale_init={layerscale_init}, "
            f"tanhscale_init={tanhscale_init}, normalize_modulator={normalize_modulator}, "
    ...
    def forward(
        ...
        # print(f"Left contexts shapes: {[lc.shape if lc is not None else None for lc in left_contexts]}")
...
class FocalDecoder(nn.Module):
    ...
    def __init__(
        ...
        print(
            ...
            f"input_dim={input_dim}, output_dim={output_dim}, "
            f"hidden_dims={hidden_dims}, upscale_factors={upscale_factors}, "
            f"focal_window={focal_window}, focal_level={focal_level}, focal_factor={focal_factor}, "
            f"dropout={dropout}, use_post_norm={use_post_norm}, "
            f"use_layerscale={use_layerscale}, layerscale_init={layerscale_init}, "
            f"tanhscale_init={tanhscale_init}, normalize_modulator={normalize_modulator}, "
            f"causal={causal}, window_size={window_size}, last_window_size={last_window_size}, lookahead_size={lookahead_size}"
        )
