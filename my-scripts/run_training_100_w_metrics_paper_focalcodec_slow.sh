#!/bin/bash
#$ -o /mnt/matylda6/xdobos00/runs/logs/focalcodec-slow-$JOB_NAME.$JOB_ID.out
#$ -e /mnt/matylda6/xdobos00/runs/logs/focalcodec-slow-$JOB_NAME.$JOB_ID.err
...
CONFIG_NAME="focalcodec-slow.yaml"
